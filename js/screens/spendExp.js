               ...
               var exp1cost =  ((game.data.exp1 + 1) * 10);
                ...
                me.game.world.addChild (new (me.Renderable.extend ({
                    ...
                    draw: function (renderer) {
                        this.font.draw(renderer.getContext(), "PRESS F1-F4 TO BUY, AND F5 TO SKIP, SCRUB.", this.pos.x , this.pos.y); this.font.draw(renderer.getContext(), "CURRENT EXP: " + game.data.exp.toString(), this.pos.x + 100 , this.pos.y - 50);  
                        ...
                        this.font.draw(renderer.getContext(), "F3:INCREASE ATTACK DAMAGE. BUM ", this.pos.x , this.pos.y + 200); 
