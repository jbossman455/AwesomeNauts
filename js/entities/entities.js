game.PlayerEntity = me.Entity.extend({
    ...
    checkAttack: function(xdif, ydif) {
        //console.log(this.renderable.isCurrentAnimation('attack') + " " + (this.now - this.lastHit >= game.data.playerAttackTimer) + " " + (((xdif > 0) && this.facing === "left") || ((xdif < 0) && this.facing === "right")));
        if (this.renderable.isCurrentAnimation('attack') && this.now - this.lastHit >= game.data.playerAttackTimer &&
                (Math.abs(ydif) <= 40) &&
