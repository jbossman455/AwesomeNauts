  ...
  game.SpendGold = Object.extend ({
      ...
      setBuyText: function(){
            game.data.buytext = (new (me.Renderable.extend ({
                    ...
                    draw: function (renderer) {
                        this.font.draw(renderer.getContext(), "PRESS F1-F4 TO BUY, AND B TO EXIT, SCRUB. Current Gold: " + game.data.gold, this.pos.x , this.pos.y); this.font.draw(renderer.getContext(), "CURRENT EXP: " + game.data.exp.toString(), this.pos.x + 100 , this.pos.y - 50);  
                        ...
                        this.font.draw(renderer.getContext(), "QSKILL: Speed Burst. Current Level" + game.data.ability1 + "Cost: " + ((game.data.ability1+1)*10), this.pos.x ,  this.pos.y + 160);  
                        this.font.draw(renderer.getContext(), "W SKILL: Eat your Creep for Health:" + game.data.ability2 + "Cost: " + ((game.data.abiility2+1)*10), this.pos.x ,  this.pos.y + 200);  
     ...
     game.data.gold -= ((game.ability1 + 1)* 10);
